...
namespace NBDProject.Controllers
{
    public class WorkTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,workTypeDesc,workTypePrice,workTypeCost")] WorkType workType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,workTypeDesc,workTypePrice,workTypeCost")] WorkType workType)
        {
            if (ModelState.IsValid)
            {
